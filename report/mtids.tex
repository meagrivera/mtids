...
combines tools used for graph theory analysis (Matgraph) and the simulation of interconnected systems (Simulink) to create a flexible and extensible 
framework, in order to make the simulation of interconnected dynamical systems easier for students and researchers.\\
...
MTIDS is a toolbox aimed for students and researchers working in the field of large-scale and interconnected dynamical systems. We would like to conform a community 
