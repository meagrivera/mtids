...
A node needs to have: A unique label, an assigned dynamic/template
Nodes added by using the mouse (\verb|<shift>-<left-click>|) are given the last selected node dynamics and node labe.
