...
\begin{figure}[htb]
\centering
\mbox{\subfigure[Node for concept 1]{\includegraphics[width=.5 \textwidth]{pics/screenNode.eps} }\quad
\subfigure[Node for concept 2]{\includegraphics[width=.5\textwidth]{pics/screenConcept2.eps}  }}
...
The consensus or rendezvous problem is a classic formulation where a distributed host-less algorithm with simple
